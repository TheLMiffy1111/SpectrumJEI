...
public class GuiRenderUtil {
	...
	public static void blit(DrawContext guiGraphics, Identifier atlasLocation, float x, float y, float uOffset, float vOffset, float width, float height, int textureWidth, int textureHeight) {
	...
	public static void blitSprite(DrawContext guiGraphics, Sprite sprite, float x, float y, float uOffset, float vOffset, float width, float height, int textureWidth, int textureHeight) {
		...
		blit(guiGraphics, sprite.getAtlasId(), x, x + width, y, y + height, uMin, uMax, vMin, vMax);
	}

	static void blit(DrawContext guiGraphics, Identifier atlasLocation, float xMin, float xMax, float yMin, float yMax, float uMin, float uMax, float vMin, float vMax) {
